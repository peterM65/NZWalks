...
namespace NZWalks.API.Controllers
{
    ...
    public class WalksController : ControllerBase
    {
        ...
        [Route("{id:Guid}")]
        [ValidateModel]
        public async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] UpdateWolkRequestDto updateWolkRequestDto)
        {

            //Map DTO To Domain Model
            var walkDomainModel = mapper.Map<Walk>(updateWolkRequestDto);
